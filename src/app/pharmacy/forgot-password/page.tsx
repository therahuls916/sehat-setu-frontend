// src/app/pharmacy/forgot-password/page.tsx
'use client';
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-lg relative">
        <Link href="/pharmacy/login" className="absolute top-4 left-4 text-gray-500 hover:text-gray-800">
            <ArrowLeft size={24} />
        </Link>
        <div className="text-center pt-6">
          <Pill size={36} className="text-green-500 mx-auto" />
        ...
        <form onSubmit={handlePasswordReset} className="space-y-6">
          ...
          <div>
            <button type="submit" className="w-full px-4 py-2 font-bold text-white bg-green-500 rounded-md disabled:bg-gray-400" disabled={isLoading}>
