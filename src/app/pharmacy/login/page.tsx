          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <input 
                ...
                required 
                className="mt-1 block w-full rounded-lg border-gray-300 dark:border-dark-border bg-gray-50 dark:bg-dark-surface px-4 py-3 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 dark:focus:ring-green-500/50 focus:ring-opacity-50"
